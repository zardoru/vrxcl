...
extern double INITIAL_ARMOR_ALIEN;
...
extern double LEVELUP_ARMOR_ALIEN;
...
extern double M_ENFORCER_CONTROL_COST;
...
extern double M_JORG_CONTROL_COST;
extern double M_CONTROL_COST_SCALE;
extern double M_COMMANDER_CONTROL_COST;
extern double M_MUTANT_CONTROL_COST;
extern double M_BERSERKER_CONTROL_COST;
...
extern double INVASION_EXP_SPLIT;
extern double INVASION_ASSIST_EXP_PERCENT;
...
extern double M_ENFORCER_INITIAL_HEALTH;
extern double M_ENFORCER_ADDON_HEALTH;
extern double M_ENFORCER_INITIAL_ARMOR;
extern double M_ENFORCER_ADDON_ARMOR;
...
extern double PVB_BOSS_EXPERIENCE;
extern double PVB_BOSS_MIN_EXP;
extern double PVB_BOSS_MAX_EXP;
extern double PVB_BOSS_CREDITS;
extern double PVB_BOSS_FRAG_EXP;
extern double PVB_BOSS_FRAG_CREDITS;
extern double PVB_BOSS_TIMEOUT;
extern double GROUP_SHARE_MULT;
extern double CTF_ASSIST_DURATION;
extern double CTF_SUMMONABLE_AUTOREMOVE;
extern double CTF_FLAG_CAPTURE_EXP;
extern double CTF_FLAG_ASSIST_EXP;
extern double CTF_FLAG_CAPTURE_CREDITS;
extern double CTF_MINIMUM_PLAYERS;
extern double CTF_FLAG_DEFEND_RANGE;
extern double CTF_BASE_DEFEND_RANGE;
extern double CTF_FLAG_DEFEND_EXP;
extern double CTF_FLAG_DEFEND_CREDITS;
extern double CTF_FLAG_KILL_EXP;
extern double CTF_FLAG_KILL_CREDITS;
extern double CTF_BASE_DEFEND_EXP;
extern double CTF_BASE_DEFEND_CREDITS;
extern double CTF_BASE_KILL_EXP;
extern double CTF_BASE_KILL_CREDITS;
extern double CTF_FLAG_RETURN_EXP;
extern double CTF_FLAG_RETURN_CREDITS;
extern double CTF_FLAG_TAKE_EXP;
extern double CTF_FLAG_TAKE_CREDITS;
extern double CTF_FRAG_EXP;
extern double CTF_FRAG_CREDITS;
extern double CTF_PLAYERSPAWN_HEALTH;
extern double CTF_PLAYERSPAWN_CAPTURE_EXPERIENCE;
extern double CTF_PLAYERSPAWN_CAPTURE_CREDITS;
extern double CTF_PLAYERSPAWN_DEFENSE_RANGE;
extern double CTF_PLAYERSPAWN_DEFENSE_EXP;
extern double CTF_PLAYERSPAWN_DEFENSE_CREDITS;
extern double CTF_PLAYERSPAWN_OFFENSE_EXP;
extern double CTF_PLAYERSPAWN_OFFENSE_CREDITS;
extern double CTF_PLAYERSPAWN_TIME;
extern double CTF_PLAYERSPAWN_MAX_TIME;
extern double CORPSEEATER_DELAY;
extern double CORPSEEATER_RANGE;
extern double CORPSEEATER_INITIAL_HEALTH;
extern double CORPSEEATER_ADDON_HEALTH;
extern double CORPSEEATER_INITIAL_DAMAGE;
extern double CORPSEEATER_ADDON_DAMAGE;
extern double CORPSEEATER_ADDON_MAXHEALTH;

extern double AUTOCANNON_ATTACK_DELAY;
extern double AUTOCANNON_START_DELAY;
extern double AUTOCANNON_BUILD_TIME;
extern double AUTOCANNON_DELAY;
extern double AUTOCANNON_RANGE;
extern double AUTOCANNON_INITIAL_HEALTH;
extern double AUTOCANNON_ADDON_HEALTH;
extern double AUTOCANNON_INITIAL_DAMAGE;
extern double AUTOCANNON_ADDON_DAMAGE;
extern double AUTOCANNON_YAW_SPEED;
extern double AUTOCANNON_COST;
extern double AUTOCANNON_MAX_UNITS;
extern double AUTOCANNON_START_AMMO;
extern double AUTOCANNON_INITIAL_AMMO;
extern double AUTOCANNON_ADDON_AMMO;
extern double AUTOCANNON_REPAIR_COST;
extern double AUTOCANNON_TOUCH_DELAY;
extern double HOLYGROUND_INITIAL_DURATION;
extern double HOLYGROUND_ADDON_DURATION;
extern double HOLYGROUND_COST;
extern double HOLYGROUND_DELAY;
extern double COCOON_INITIAL_HEALTH;
extern double COCOON_ADDON_HEALTH;
extern double COCOON_INITIAL_DURATION;
extern double COCOON_ADDON_DURATION;
extern double COCOON_MINIMUM_DURATION;
extern double COCOON_INITIAL_FACTOR;
extern double COCOON_ADDON_FACTOR;
extern double COCOON_INITIAL_TIME;
extern double COCOON_ADDON_TIME;
extern double COCOON_COST;
extern double COCOON_DELAY;
extern double BOLT_SPEED;
extern double BOLT_DURATION;
extern double BOLT_INITIAL_DAMAGE;
extern double BOLT_ADDON_DAMAGE;
extern double BOLT_DELAY;
extern double IMP_BOLT_DELAY;
extern double IMP_BOLT_RADIUS;
extern double SPIKE_INITIAL_DMG;
extern double SPIKE_ADDON_DMG;
extern double SPIKE_SPEED;
extern double SPIKE_COST;
extern double SPIKE_DELAY;
extern double SPIKE_STUN_ADDON;
extern double SPIKE_STUN_MIN;
extern double SPIKE_STUN_MAX;
extern double SPIKE_SHOTS;
extern double SPIKE_FOV;
extern double PROXY_COST;
extern double PROXY_MAX_COUNT;
extern double PROXY_BUILD_TIME;
extern double PROXY_BASE_DMG;
extern double PROXY_ADDON_DMG;
extern double PROXY_BASE_RADIUS;
extern double PROXY_ADDON_RADIUS;
extern double PROXY_BASE_HEALTH;
extern double PROXY_ADDON_HEALTH;
extern double NAPALM_MAX_COUNT;
extern double NAPALM_ATTACK_DELAY;
extern double NAPALM_DELAY;
extern double NAPALM_COST;
extern double NAPALM_DURATION;
extern double NAPALM_INITIAL_DMG;
extern double NAPALM_ADDON_DMG;
extern double NAPALM_INITIAL_RADIUS;
extern double NAPALM_ADDON_RADIUS;
extern double NAPALM_INITIAL_BURN;
extern double NAPALM_ADDON_BURN;
extern double METEOR_INITIAL_DMG;
extern double METEOR_ADDON_DMG;
extern double METEOR_INITIAL_RADIUS;
extern double METEOR_ADDON_RADIUS;
extern double METEOR_INITIAL_SPEED;
extern double METEOR_ADDON_SPEED;
extern double METEOR_CEILING_HEIGHT;
extern double METEOR_RANGE;
extern double METEOR_DELAY;
extern double CLIGHTNING_COLOR;
extern double CLIGHTNING_PARTICLES;
extern double CLIGHTNING_INITIAL_DMG;
extern double CLIGHTNING_ADDON_DMG;
extern double CLIGHTNING_INITIAL_AR;
extern double CLIGHTNING_ADDON_AR;
extern double CLIGHTNING_INITIAL_HR;
extern double CLIGHTNING_ADDON_HR;
extern double CLIGHTNING_DELAY;
extern double CLIGHTNING_DMG_MOD;
extern double HAMMER_INITIAL_SPEED;
extern double HAMMER_ADDON_SPEED;
extern double HAMMER_TURN_RATE;
extern double HAMMER_INITIAL_DAMAGE;
extern double HAMMER_ADDON_DAMAGE;
extern double HAMMER_COST;
extern double HAMMER_DELAY;
extern double BLACKHOLE_COST;
extern double BLACKHOLE_DELAY;
extern double BLACKHOLE_EXIT_TIME;
extern double CALTROPS_INITIAL_DAMAGE;
extern double CALTROPS_ADDON_DAMAGE;
extern double CALTROPS_INITIAL_SLOW;
extern double CALTROPS_ADDON_SLOW;
extern double CALTROPS_INITIAL_SLOWED_TIME;
extern double CALTROPS_ADDON_SLOWED_TIME;
extern double CALTROPS_DURATION;
extern double CALTROPS_COST;
extern double CALTROPS_DELAY;
extern double CALTROPS_MAX_COUNT;
extern double SPIKEGRENADE_COST;
extern double SPIKEGRENADE_DELAY;
extern double SPIKEGRENADE_DURATION;
extern double SPIKEGRENADE_INITIAL_DAMAGE;
extern double SPIKEGRENADE_ADDON_DAMAGE;
extern double SPIKEGRENADE_INITIAL_SPEED;
extern double SPIKEGRENADE_ADDON_SPEED;
extern double SPIKEGRENADE_TURN_DEGREES;
extern double SPIKEGRENADE_TURN_DELAY;
extern double SPIKEGRENADE_TURNS;
extern double SPIKEGRENADE_MAX_COUNT;
extern double LASERTRAP_INITIAL_HEALTH;
extern double LASERTRAP_ADDON_HEALTH;
extern double LASERTRAP_INITIAL_DAMAGE;
extern double LASERTRAP_ADDON_DAMAGE;
extern double LASERTRAP_DELAY;
extern double LASERTRAP_COST;
extern double LASERTRAP_RANGE;
extern double LASERTRAP_MINIMUM_RANGE;
extern double LASERTRAP_YAW_SPEED;
extern double DETECTOR_COST;
extern double DETECTOR_DELAY;
extern double DETECTOR_MAX_COUNT;
extern double DETECTOR_INITIAL_HEALTH;
extern double DETECTOR_ADDON_HEALTH;
extern double DETECTOR_INITIAL_RANGE;
extern double DETECTOR_ADDON_RANGE;
extern double DETECTOR_DURATION;
extern double DETECTOR_FLAG_DURATION;
extern double DETECTOR_GLOW_TIME;
extern double ALARM_INITIAL_HEALTH;
extern double ALARM_ADDON_HEALTH;
extern double ALARM_INITIAL_RANGE;
extern double ALARM_ADDON_RANGE;
extern double CONVERSION_INITIAL_RANGE;
extern double CONVERSION_ADDON_RANGE;
extern double CONVERSION_INITIAL_DURATION;
extern double CONVERSION_ADDON_DURATION;
extern double CONVERSION_INITIAL_CHANCE;
extern double CONVERSION_ADDON_CHANCE;
extern double CONVERSION_MAX_CHANCE;
extern double CONVERSION_COST;
extern double CONVERSION_DELAY;
extern double MIRROR_INITIAL_HEALTH;
extern double MIRROR_ADDON_HEALTH;
extern double MIRROR_COST;
extern double MIRROR_DELAY;
extern double FIREBALL_INITIAL_DAMAGE;
extern double FIREBALL_ADDON_DAMAGE;
extern double FIREBALL_INITIAL_RADIUS;
extern double FIREBALL_ADDON_RADIUS;
extern double FIREBALL_INITIAL_SPEED;
extern double FIREBALL_ADDON_SPEED;
extern double FIREBALL_INITIAL_FLAMES;
extern double FIREBALL_ADDON_FLAMES;
extern double FIREBALL_INITIAL_FLAMEDMG;
extern double FIREBALL_ADDON_FLAMEDMG;
extern double FIREBALL_DELAY;
extern double LIGHTNING_STRIKE_RADIUS;
extern double LIGHTNING_MIN_DELAY;
extern double LIGHTNING_MAX_DELAY;
extern double LIGHTNING_INITIAL_DAMAGE;
extern double LIGHTNING_ADDON_DAMAGE;
extern double LIGHTNING_INITIAL_DURATION;
extern double LIGHTNING_ADDON_DURATION;
extern double LIGHTNING_INITIAL_RADIUS;
extern double LIGHTNING_ADDON_RADIUS;
extern double LIGHTNING_ABILITY_DELAY;
extern double PLASMABOLT_INITIAL_DAMAGE;
extern double PLASMABOLT_ADDON_DAMAGE;
extern double PLASMABOLT_INITIAL_RADIUS;
extern double PLASMABOLT_ADDON_RADIUS;
extern double PLASMABOLT_INITIAL_SPEED;
extern double PLASMABOLT_ADDON_SPEED;
extern double PLASMABOLT_INITIAL_DURATION;
extern double PLASMABOLT_ADDON_DURATION;
extern double PLASMABOLT_COST;
extern double PLASMABOLT_DELAY;
extern double PLASMABOLT_DELAY_PVP;
extern double ICEBOLT_INITIAL_DAMAGE;
extern double ICEBOLT_ADDON_DAMAGE;
extern double ICEBOLT_INITIAL_RADIUS;
extern double ICEBOLT_ADDON_RADIUS;
extern double ICEBOLT_INITIAL_SPEED;
extern double ICEBOLT_ADDON_SPEED;
extern double ICEBOLT_INITIAL_CHILL_DURATION;
