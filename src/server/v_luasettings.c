...
double ENFORCER_INIT_COST;
double ENFORCER_DELAY;
double ENFORCER_MG_INITIAL_DMG;
double ENFORCER_MG_ADDON_DMG;
double ENFORCER_MG_INITIAL_SPEED;
double ENFORCER_MG_ADDON_SPEED;
double ENFORCER_MG_INITIAL_AMMO;
double ENFORCER_MG_ADDON_AMMO;
double ENFORCER_MG_START_AMMO;
double ENFORCER_MG_REGEN_FRAMES;
double ENFORCER_MG_REGEN_DELAY;
double ENFORCER_SMACK_INITIAL_DMG;
double ENFORCER_SMACK_ADDON_DMG;
double ENFORCER_SMACK_RANGE;
...
#pragma endregion /*Weapons Parameters*/
	...
	ENFORCER_INIT_COST = vrx_lua_get_variable("ENFORCER_INIT_COST", 50);
	ENFORCER_DELAY = vrx_lua_get_variable("ENFORCER_DELAY", 1.0);
	ENFORCER_MG_INITIAL_DMG = vrx_lua_get_variable("ENFORCER_MG_INITIAL_DMG", 10);
	ENFORCER_MG_ADDON_DMG = vrx_lua_get_variable("ENFORCER_MG_ADDON_DMG", 2.0);
	ENFORCER_MG_INITIAL_AMMO = vrx_lua_get_variable("ENFORCER_MG_INITIAL_AMMO", 50);
	ENFORCER_MG_ADDON_AMMO = vrx_lua_get_variable("ENFORCER_MG_ADDON_AMMO", 25);
	ENFORCER_MG_START_AMMO = vrx_lua_get_variable("ENFORCER_MG_START_AMMO", 50);
	ENFORCER_MG_REGEN_FRAMES = vrx_lua_get_variable("ENFORCER_MG_REGEN_FRAMES", 100);
	ENFORCER_MG_REGEN_DELAY = vrx_lua_get_variable("ENFORCER_MG_REGEN_DELAY", 5);
	ENFORCER_SMACK_RANGE = vrx_lua_get_variable("ENFORCER_SMACK_RANGE", 200);
	ENFORCER_SMACK_INITIAL_DMG = vrx_lua_get_variable("ENFORCER_SMACK_INITIAL_DMG", 100);
	ENFORCER_SMACK_ADDON_DMG = vrx_lua_get_variable("ENFORCER_SMACK_ADDON_DMG", 25);
